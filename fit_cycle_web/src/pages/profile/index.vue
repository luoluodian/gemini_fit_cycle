  ...
  <view class="min-h-screen">
    ...
    <view class="px-4 py-6 pb-20">
      ...
      <QuickStats
        ...
        :completed-plans="userData.completedPlans"
      ...
      <WeeklyProgressChart
        :stats="weeklyStats"
        @view-details="handleViewFullStats"
        class="animate-fade-in-up delay-200"
      />

      <!-- Menu Items -->
      <view class="space-y-4 animate-fade-in-up delay-300">
        <!-- Health Tools -->
        <HealthTools
...
const userData = computed(() => ({
  ...
  totalDays: userStore.stats?.totalDays || 0,
  completedPlans: userStore.stats?.completedPlans || 0,
}));
